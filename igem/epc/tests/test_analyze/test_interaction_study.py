...
def load_r_interaction_results(filename):
    ...
    if "Parameter" in r_result.columns:
        r_result = r_result.set_index(["Term1", "Term2", "Parameter", "Outcome"])  # noqa E501
    else:
...
def compare_result(loaded_result, python_result, atol=0, rtol=1e-04):
    ...
    if "Parameter" in python_result.index.names:
        ...
        python_result["Parameter"] = python_result["Parameter"].apply(fix_python_param)  # noqa E501
...
def test_interactions_nhanes_ageXgender(data_NHANES):
    ...
    # No Betas
    loaded_result = load_r_interaction_results(RESULT_PATH / "nhanes_ageXgender.csv")  # noqa E501
...
def test_interactions_nhanes_weightXrace(data_NHANES):
    ...
    # No Betas
    loaded_result = load_r_interaction_results(RESULT_PATH / "nhanes_weightXrace.csv")  # noqa E501
    python_result = igem.analyze.interaction_study(
        outcomes="HI_CHOL",
...
def test_interactions_nhanes_pairwise(data_NHANES):  # noqa E501
    ...
    # No Betas
    loaded_result = load_r_interaction_results(RESULT_PATH / "nhanes_pairwise.csv")  # noqa E501
    ...
    # Test Adding pvalues
    igem.analyze.add_corrected_pvalues(python_result_nobeta, pvalue="LRT_pvalue")  # noqa E501
